...
1.  본 플러그인은 '답없네 진짜' 크루의 개발자 **김미역(MiyeoukMan)** 이 제작하였습니다.
2.  유튜브, 트위치, 아프리카TV 등 **모든 동영상 스트리밍 및 콘텐츠 플랫폼**에서 본 플러그인을 사용하여 영상을 제작하는 경우, **반드시 영상 본문 또는 댓글에 본 플러그인의 GitHub 저장소 출처를 명확히 남겨야 합니다.**
3.  본 플러그인을 임의로 복사, 판매, 공유하거나 **다른 이름으로 재배포하는 것을 금지**합니다. **유튜브 컨텐츠 사용에 한해** 수정은 허용합니다.

Copyright 2025. MiyeoukMan all rights reserved.
